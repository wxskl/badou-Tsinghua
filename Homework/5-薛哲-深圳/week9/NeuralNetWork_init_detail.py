...
def __init__(self, inputnodes, hiddennodes, outputnodes, learningrate):
        ...
        '''
        self.wih = numpy.random.rand(self.hnodes, self.inodes) - 0.5  # wih输入层到隐藏层之间的权重 参数(a,b)表示生成a*b的矩阵
        self.who = numpy.random.rand(self.onodes, self.hnodes) - 0.5  # who隐藏层到输出层之间的权重
